...
subprocess.call('makeobj pak256 ../../pak/temp/ARI_local_suburb_none_along-rail.pak suburb/none/along-rail/*.dat > err.txt', cwd=r"src/local")
...
subprocess.call('makeobj pak256 ../../pak/temp/ARI_local_suburb_orange_along-rail.pak suburb/orange/along-rail/*.dat > err.txt', cwd=r"src/local")
...
subprocess.call('makeobj pak256 ../../pak/temp/ARI_local_suburb_white_along-rail.pak suburb/white/along-rail/*.dat > err.txt', cwd=r"src/local")
